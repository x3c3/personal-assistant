...
**Applies To**: All new LifeOS tools, skills, and systems
**Created**: 2025-11-15
...
- LifeOS's Skill → Workflow → Tool hierarchy is architecturally superior
...
**This pattern is now standard for all new LifeOS systems.**
